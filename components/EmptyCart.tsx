    ...
    <div className="py-10 md:py-20 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      ...
      >
        ...
        <div>
          <Link
            href="/"
            className="block bg-shop-dark-color/5 border border-shop-dark-color/20 text-center py-2.5 rounded-full text-sm font-semibold tracking-wide hover:border-shop-dark-color hover:bg-shop-dark-color hover:text-white hoverEffect"
          >
            Discover Products
          </Link>
        </div>
